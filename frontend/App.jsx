    ...
    <div className="app">
      ...
      <aside className={`sidebar ${sidebarOpen ? "open" : ""}`}>
        <div className="brand">
          ...
          <div>
            <h2 style={{ color: "#D32F2F" }}>PRIMEPOWER</h2>
        ...
        <nav>
          {menuItems.map((item) => (
            <button
              key={item.name}
              className={activePage === item.name ? "menu active" : "menu"}
              onClick={() => {
...
/* ================================
   FINANCIAL CHART (Revenue, Expenses, Profit)
=============================== */

function FinancialChart({ totalRevenue, totalExpenses, netProfit }) {
  const maxValue = Math.max(totalRevenue, totalExpenses, netProfit > 0 ? netProfit : 0);

  const revenuePercent = maxValue > 0 ? (totalRevenue / maxValue) * 100 : 0;
  const expensesPercent = maxValue > 0 ? (totalExpenses / maxValue) * 100 : 0;
  const profitPercent = maxValue > 0 && netProfit > 0 ? (netProfit / maxValue) * 100 : 0;
  ...
  return (
    <div className="financial-chart-card">
      <div className="financial-chart-header">
        ...
        <span className="ytd-badge">YTD</span>
      </div>

      <div className="financial-chart">
        <div className="financial-chart-rows">
          <div className="financial-chart-row">
            <div className="financial-chart-row-head">
              <span>Revenue</span>
              <strong>{formatMoney(totalRevenue)}</strong>
            </div>
            <div className="financial-chart-track">
              <div
                className="financial-chart-fill revenue"
          ...
          <div className="financial-chart-row">
            ...
            <div className="financial-chart-track">
              <div
                className="financial-chart-fill expenses"
          ...
          <div className="financial-chart-row">
            ...
            <div className="financial-chart-track">
              <div
                className="financial-chart-fill profit"
